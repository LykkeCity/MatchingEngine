...
CLASSPATH=$BASEDIR/lib/lykke-me-prototype-0.1.0.jar:$BASEDIR/lib/kotlin-stdlib-1.0.4.jar:$BASEDIR/lib/log4j-1.2.17.jar:$BASEDIR/lib/protobuf-java-3.0.0-beta-2.jar:$BASEDIR/lib/azure-storage-4.0.0.jar:$BASEDIR/lib/gson-2.6.2.jar:$BASEDIR/lib/httpclient-4.5.2.jar:$BASEDIR/lib/amqp-client-3.6.5.jar:$BASEDIR/lib/kotlin-runtime-1.0.4.jar:$BASEDIR/lib/jackson-core-2.6.0.jar:$BASEDIR/lib/slf4j-api-1.7.12.jar:$BASEDIR/lib/commons-lang3-3.4.jar:$BASEDIR/lib/httpcore-4.4.4.jar:$BASEDIR/lib/commons-logging-1.2.jar:$BASEDIR/lib/commons-codec-1.9.jar:$BASEDIR/lib/jackson-mapper-asl-1.8.5.jar:$BASEDIR/lib/json-20140107.jar:$BASEDIR/lib/jackson-core-asl-1.8.5.jar
