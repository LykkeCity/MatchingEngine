...
class MarketOrderPerformanceTest: AbstractPerformanceTest() {
    ...
    fun testNotEnoughFundsClientOrder(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.6, volume = 1000.0, clientId = "Client1"))
    ...
    fun testMatchOneToOneEURJPY(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "EURJPY", price = 122.512, volume = 1000000.0, clientId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "EURJPY", price = 122.524, volume = -1000000.0, clientId = "Client3"))
        initServices()
    ...
    fun testMatchOneToMany(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = 100.0, clientId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.4, volume = 1000.0, clientId = "Client1"))
        initServices()
    ...
    fun testMatchOneToMany2016Dec12(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008826, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008844, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008861, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008879, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008897, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008914, volume = -4000.0, clientId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008932, volume = -4000.0, clientId = "Client1"))
        initServices()
    ...
    fun testNotStraight(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = -500.0, assetId = "EURUSD", clientId = "Client3"))
        initServices()
    ...
    fun testNotStraightMatchOneToMany(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.4, volume = -100.0, clientId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = -1000.0, clientId = "Client1"))
        initServices()
