...
class MatchingEngineLimitOrderTest : MatchingEngineTest() {
    ...
    fun testMatchLimitOrderBuyWithEmptyOrderBook() {
        ...
        val matchingResult = match(limitOrder)
    ...
    fun testMatchLimitOrderPriceDeviation() {
        ...
        val matchingResult = match(limitOrder, priceDeviationThreshold = BigDecimal.valueOf(0.08))
    ...
    fun testMatchLimitOrderSellFullBalance() {
        ...
        val matchingResult = match(buildLimitOrder(clientId = "Client1", assetId = "LKK1YLKK", volume = -5495.03, price = 1.0082,
                fees = buildLimitOrderFeeInstructions(type = FeeType.CLIENT_FEE, takerSize = 0.0009, targetClientId = "Client5")))
