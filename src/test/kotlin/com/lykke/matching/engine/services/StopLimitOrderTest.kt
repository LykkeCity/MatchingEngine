...
class StopLimitOrderTest : AbstractTest() {
    ...
    fun testNotEnoughFunds() {
        ...
        assertEquals(0, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).size)
        assertEquals(0, testOrderDatabaseAccessor.getStopOrders("BTCUSD", false).size)
    }
    ...
    fun testAddStopLimitOrder() {
        ...
        assertEquals(1, testOrderDatabaseAccessor.getStopOrders("BTCUSD", false).size)
        assertEquals(1, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).size)
    ...
    fun testAddStopLimitOrderAndCancelAllPrevious() {
        ...
        assertEquals(1, testOrderDatabaseAccessor.getStopOrders("BTCUSD", false).size)
        assertEquals(1, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).size)
        assertEquals(-0.02, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).first().volume)
    ...
    fun testCancelStopLimitOrder() {
        ...
        assertTrue(testOrderDatabaseAccessor.getStopOrders("BTCUSD", false).isEmpty())
        assertTrue(genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).isEmpty())
    ...
    fun testProcessStopLimitOrderAfterLimitOrderCancellation() {
        ...
        assertEquals(1, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(true).size)
        assertEquals(1, testOrderDatabaseAccessor.getStopOrders("BTCUSD", true).size)
        ...
        assertEquals(0, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(true).size)
        assertEquals(0, testOrderDatabaseAccessor.getStopOrders("BTCUSD", true).size)
        assertEquals(0.0, balancesHolder.getReservedBalance("Client1", "USD"))
        assertEquals(0.0, testWalletDatabaseAccessor.getReservedBalance("Client1", "USD"))
    ...
    fun testProcessStopLimitOrderAfterMinVolumeOrdersCancellation() {
        ...
        assertEquals(1, genericLimitOrderService.getStopOrderBook("EURUSD").getOrderBook(false).size)
        ...
        assertTrue(genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(true).isEmpty())
        assertTrue(genericLimitOrderService.getStopOrderBook("EURUSD").getOrderBook(false).isEmpty())
        assertEquals(0.0, balancesHolder.getReservedBalance("Client1", "USD"))
    ...
    fun testProcessStopLimitOrdersChain() {
        ...
        assertEquals(1, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(true).size)
        assertEquals(3, genericLimitOrderService.getStopOrderBook("BTCUSD").getOrderBook(false).size)
