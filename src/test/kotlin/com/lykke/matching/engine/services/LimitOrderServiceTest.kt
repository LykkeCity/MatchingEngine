...
class LimitOrderServiceTest: AbstractTest() {
    ...
    fun testCancelPrevAndAddLimitOrder() {
        ...
        var order = testOrderDatabaseAccessor.loadLimitOrders().find { RoundingUtils.equalsIgnoreScale(it.price, BigDecimal.valueOf(300.0)) }
        assertNotNull(order)
        ...
        assertEquals(1, testOrderDatabaseAccessor.getOrders("EURUSD", true).size)
        order = testOrderDatabaseAccessor.loadLimitOrders().find { RoundingUtils.equalsIgnoreScale(it.price, BigDecimal.valueOf(500.0)) }
        assertNotNull(order)
    }
    ...
    fun testAddAndMatchWithLimitOrder() {
        ...
        assertEquals(RoundingUtils.setScale(BigDecimal.valueOf(263.33 + 139.59), 2, true),
    ...
    fun testReservedBalanceAfterMatching() {
        ...
        assertEquals(BigDecimal.ZERO, testWalletDatabaseAccessor.getReservedBalance(client, "BTC"))
    }
    ...
    fun testLimitOrderSellFullBalance() {
        ...
        assertEquals(BigDecimal.ZERO, balancesHolder.getBalance("Client1", "LKK1Y"))
        assertEquals(1, clientsLimitOrdersQueue.size)
