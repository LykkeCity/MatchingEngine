...
class MarketOrderServiceTest: AbstractTest() {
    ...
    fun testBuyPriceDeviationThreshold() {
        ...
        testSettingsDatabaseAccessor.createOrUpdateSetting(AvailableSettingGroups.MO_PRICE_DEVIATION_THRESHOLD.name, getSetting("0.0", "EURUSD"))
        ...
        testSettingsDatabaseAccessor.createOrUpdateSetting(AvailableSettingGroups.MO_PRICE_DEVIATION_THRESHOLD.name, getSetting("0.04", "EURUSD"))
        applicationSettingsCache.update()
        ...
        testSettingsDatabaseAccessor.createOrUpdateSetting(AvailableSettingGroups.MO_PRICE_DEVIATION_THRESHOLD.name, getSetting("0.05", "EURUSD"))
        applicationSettingsCache.update()
