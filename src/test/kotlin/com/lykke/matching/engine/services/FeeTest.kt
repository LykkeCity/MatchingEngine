...
class FeeTest {
    ...
    private fun initServices() {
        ...
        singleLimitOrderService = SingleLimitOrderService(genericService, trustedClientsLimitOrdersQueue, clientLimitOrdersQueue, orderBookQueue, rabbitOrderBookQueue, assetsHolder, assetsPairsHolder, balancesHolder, disabledAssetsCache, lkkTradesQueue)
