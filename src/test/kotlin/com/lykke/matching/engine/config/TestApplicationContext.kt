...
open class TestApplicationContext {
    ...
    @Bean
    open fun genericLimitOrderService(testOrderDatabaseAccessor: TestFileOrderDatabaseAccessor,
        ...
        return GenericLimitOrderService(testOrderDatabaseAccessor, assetsPairsHolder, balancesHolder,
