    ...
    override fun run() {
        while (true) {
            ...
            if (connections.size > 0) {
                val protoNotification = ProtocolMessages.QuotesUpdate.newBuilder().setAssetId(notification.asset).setPrice(notification.price.toDouble()).setVolume(notification.volume.toDouble()).build()
