...
open class ExecutionContext(val messageId: String,
                            ...
                            open val assetPairsById: Map<String, AssetPair>,
                            ...
                            open val orderBooksHolder: CurrentTransactionOrderBooksHolder,
    ...
    fun controlsInfo(message: String) {
        controlsLogger.info(getLogMessage(message))
    }

    fun controlsError(message: String) {
        controlsLogger.error(getLogMessage(message))
    }
