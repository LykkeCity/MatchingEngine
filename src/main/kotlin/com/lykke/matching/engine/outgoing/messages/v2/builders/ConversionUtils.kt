...
private fun orderStatusInfo(order: com.lykke.matching.engine.daos.Order): OrderStatusInfo {
    return when (order.status) {
        ...
        com.lykke.matching.engine.order.OrderStatus.OrderBookMaxSizeReached.name -> OrderStatusInfo(OrderStatus.REJECTED, OrderRejectReason.ORDER_BOOK_MAX_SIZE_REACHED)
