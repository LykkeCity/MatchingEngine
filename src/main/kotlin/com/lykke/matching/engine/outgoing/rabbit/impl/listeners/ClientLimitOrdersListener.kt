...
class ClientLimitOrdersListener {
    ...
    @EventListener
    fun process(limitOrdersReportEvent: LimitOrdersReportEvent) {
        queue.put(limitOrdersReportEvent.limitOrdersReport)
    }

    @PostConstruct
    fun initRabbitMqPublisher() {
        rabbitMqService.startPublisher(config.me.rabbitMqConfigs.trustedLimitOrders, queue,
                config.me.name,
                AppVersion.VERSION,
