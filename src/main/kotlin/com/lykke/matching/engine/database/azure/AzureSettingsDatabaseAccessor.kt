...
class AzureSettingsDatabaseAccessor(settingsConnString: String): SettingsDatabaseAccessor {
    ...
    private val settingsTable: CloudTable = getOrCreateTable(settingsConnString, "MatchingEngineSettings")
