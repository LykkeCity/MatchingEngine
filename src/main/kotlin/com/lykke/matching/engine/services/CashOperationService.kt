...
class CashOperationService(private val cashOperationsDatabaseAccessor: CashOperationsDatabaseAccessor,
    ...
    override fun processMessage(messageWrapper: MessageWrapper) {
        ...
        val externalCashOperation = cashOperationsDatabaseAccessor.loadExternalCashOperation(message.clientId, message.bussinesId)
        ...
        cashOperationsDatabaseAccessor.insertExternalCashOperation(ExternalCashOperation(operation.clientId, message.bussinesId, operation.id))
