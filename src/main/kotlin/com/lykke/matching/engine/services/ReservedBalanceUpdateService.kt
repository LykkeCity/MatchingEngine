...
class ReservedBalanceUpdateService(private val balancesHolder: BalancesHolder) : AbstractService {
    ...
    override fun processMessage(messageWrapper: MessageWrapper) {
        ...
        balancesHolder.sendBalanceUpdate(BalanceUpdate(message.uid, MessageType.RESERVED_BALANCE_UPDATE.name, Date(),
                listOf(ClientBalanceUpdate(message.clientId, message.assetId, balance, balance, currentReservedBalance, BigDecimal.valueOf(message.reservedAmount)))))
