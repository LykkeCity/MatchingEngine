...
class CashInOutOperationService(private val assetsHolder: AssetsHolder,
    ...
    override fun processMessage(messageWrapper: MessageWrapper) {
        ...
        publishRabbitMessage(message, walletOperation, fees, message.messageId!!)
    ...
    private fun publishRabbitMessage(message: ProtocolMessages.CashInOutOperation, walletOperation: WalletOperation, fees: List<Fee>, messageId: String) {
