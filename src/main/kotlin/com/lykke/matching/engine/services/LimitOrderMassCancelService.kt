...
class LimitOrderMassCancelService(private val genericLimitOrderService: GenericLimitOrderService,
    ...
    override fun processMessage(messageWrapper: MessageWrapper) {
        ...
        LOGGER.debug("Got mass limit order cancel request id: ${context.uid}, messageId: ${context.messageId}, clientId: ${context.clientId}, assetPairId: ${context.assetPairId}, isBuy: ${context.isBuy}")
