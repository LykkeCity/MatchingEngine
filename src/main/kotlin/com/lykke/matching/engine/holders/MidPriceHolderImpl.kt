...
@Component
class MidPriceHolderImpl(@Value("#{Config.me.referenceMidPricePeriod}") val refreshMidPricePeriod: Long,
                         readOnlyMidPriceDatabaseAccessor: ReadOnlyMidPriceDatabaseAccessor,
                         private val orderBookMidPriceChecker: OrderBookMidPriceChecker): MidPriceHolder {
    ...
    override fun getReferenceMidPrice(assetPair: AssetPair,
                             executionContext: ExecutionContext,
                             notSavedMidPricesSum: BigDecimal?,
                             notSavedMidPricesLength: Int?): BigDecimal {
        if (notSavedMidPricesSum == null || notSavedMidPricesLength == null) {
